...
<h1>WishList</h1>
 <div>
	<p style="font-size:18px;padding:0px 5px 0px 5px;">Books in your Wishlist are those which you don't have and wish to exchange/borrow from
		other users who work in your company or study in your school/college
		or reside in the same locality/building.</p>
</div> 
<div style="padding-left:400px;margin-top:-10px;"  id="wishAddButton">
<input type="button" value="Add Books to WishList" class="button" onclick="showWishListAddBox();"/>
</div>
...
<div id="showWishlist" style="height:320px;overflow:auto;border-bottom:1px solid silver;">
			...
			<s:iterator value="wishList" status="hDStatus" >
				<s:div  cssClass="bookDesc" id="divId%{#hDStatus.count}">
					...
					<s:else><tr></s:else>
						...
						<td><s:property value="wishtype"/></td>
...
<form name="WishListForm" id="WishListForm"  method="post">
	<table width="100%">
		...
		<tr>
			...
			<td><input type="button" value="View WishList" class="button" onclick="viewWishList()"></td>
		</tr>
	</table>
